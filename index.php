        ...
        <nav class="navbar">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="a"><span class="JOSH">JOSH</span> <span class="orange">WHITKIN</span></a>
                </div>
    ...
    <section class="container-fluid articlesbg">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <img class="img-responsive" alt="portait" src="Images/portrate.jpg"> 
                ...
                <div class="col-md-4">
                    <img class="img-responsive" alt="portait" src="Images/games.jpg">
