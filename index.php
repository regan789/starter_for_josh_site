...
wp_reset_query();?>    
    ...
    <section class="container-fluid articlesbg">
        ...
        <div class="container">
            ...
            <div class="row">
                <!--                a row that gives us access to the BS collumn-->
                ...
                <div class="col-md-4">
                    <img class="img-responsive" alt="portait" src="http://206.189.45.97/~mesh2/wp-content/themes/starter_for_josh_site/images/portrait.jpg"> 
                ...
                <div class="col-md-4">
                    <img class="img-responsive" alt="portait" src="http://206.189.45.97/~mesh2/wp-content/themes/starter_for_josh_site/images/model.jpg">
